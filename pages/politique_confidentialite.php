    ...
    <div class="row g-4 justify-content-center">
      <div class="col-12 col-lg-9">
        <div class="ud-surface ud-about-card">
          ...
          <h2 class="h5 mt-4">4. Durée de conservation</h2>
          ...
          <h2 class="h5 mt-4">5. Destinataires des données</h2>
          <p class="ud-about-p mb-2">
          ...
          <h2 class="h5 mt-4">6. Transferts hors de l’Union européenne</h2>
          <p class="ud-about-p mb-0">
          ...
          <h2 class="h5 mt-4">7. Vos droits (RGPD)</h2>
          <p class="ud-about-p mb-0">
          ...
          <h2 class="h5 mt-4">8. Cookies et traceurs</h2>
          <p class="ud-about-p mb-0">
          ...
          <h2 class="h5 mt-4">9. Modifications</h2>
          <p class="ud-about-p mb-0">
